...
mixin _$FilterStore on FilterStoreBase, Store {
  ...
  late final _$isPriceFilterAppliedAtom =
      Atom(name: 'FilterStoreBase.isPriceFilterApplied', context: context);

  @override
  bool get isPriceFilterApplied {
    _$isPriceFilterAppliedAtom.reportRead();
    return super.isPriceFilterApplied;
  }

  @override
  set isPriceFilterApplied(bool value) {
    _$isPriceFilterAppliedAtom.reportWrite(value, super.isPriceFilterApplied,
        () {
      super.isPriceFilterApplied = value;
    });
  }
  ...
  late final _$addToCategoryListAsyncAction =
      AsyncAction('FilterStoreBase.addToCategoryList', context: context);

  @override
  Future<void> addToCategoryList({required int catId}) {
    return _$addToCategoryListAsyncAction
        .run(() => super.addToCategoryList(catId: catId));
  }

  late final _$removeFromCategoryListAsyncAction =
      AsyncAction('FilterStoreBase.removeFromCategoryList', context: context);

  @override
  Future<void> removeFromCategoryList({required int catId}) {
    return _$removeFromCategoryListAsyncAction
        .run(() => super.removeFromCategoryList(catId: catId));
  }
  ...
  void setPriceRange({required double min, required double max}) {
    ...
    try {
      return super.setPriceRange(min: min, max: max);
    } finally {
      _$FilterStoreBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  void resetPriceFilter() {
    final _$actionInfo = _$FilterStoreBaseActionController.startAction(
        name: 'FilterStoreBase.resetPriceFilter');
    try {
