...
Future<List<PostJobData>> getPostJobList(int page, {
  ...
  try {
    ...
    var res = PostJobResponse.fromJson(await handleResponse(await buildHttpResponse(url, method: HttpMethodType.GET)));
...
Future<List<OfferPackageModel>> getOfferPackageList() async {
  try {
    OfferPackageListResponse res = OfferPackageListResponse.fromJson(
      await handleResponse(await buildHttpResponse('offer-package-list', method: HttpMethodType.GET)),
    );
...
Future<OfferPackageStatusResponse> getOfferPackageStatus() async {
  try {
    ...
    var response = await buildHttpResponse('get-offer-package-status', method: HttpMethodType.GET);
