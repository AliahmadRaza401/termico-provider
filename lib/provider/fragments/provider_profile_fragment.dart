                    ...
                    child: Column(
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(languages.lblJobOfferPackages, style: secondaryTextStyle(color: whiteColor)),
                            Text(
                              appStore.offerPackageName.validate().capitalizeFirstLetter(),
                              style: boldTextStyle(color: Colors.yellow),
                            ),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '${appStore.offerPackageOffersPerMonth.validate()} ${languages.lblOffersPerMonth}',
                              style: boldTextStyle(color: whiteColor, fontStyle: FontStyle.italic, size: 12),
                            ),
                          ],
                        )
